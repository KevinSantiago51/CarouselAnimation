...
struct SnapCarousel<Content: View,T: Identifiable>: View {
    ...
    var body: some View{
        GeometryReader{proxy in
            ...
            //Spacing will be horinzontal padding...
            ...
            .gesture(
                ...
                DragGesture()
                    ...
                    .onEnded({ value in
                        ...
                        //were going to convert the translation into progress (0 - 0)
                        //and round the value...
                        //based on the progress increassing or decreasing the currentIndex...
    ...
    func getOffset(item: T,width: CGFloat)->CGFloat{
        ...
        //checking current...
        //if so shifting view to the top...
